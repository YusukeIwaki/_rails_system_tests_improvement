...
[`ActionDispatch::EssentialSystemTestCase`](https://api.rubyonrails.org/classes/ActionDispatch/EssentialSystemTestCase.html)
...
To use it, inherit from `ActionDispatch::EssentialSystemTestCase` in your
...
class ApplicationSystemTestCase < ActionDispatch::EssentialSystemTestCase
